      ...
      <div className={UI.container}> 
        ...
        <div className={UI.grid}>
          <div className={UI.card}>
            <Image className={styles.icon} src="/pc.svg" alt="PC Logo" width={42} height={36} />
            <h2>PC Building</h2>
            <p>
          ...
          <div className={UI.card}>
            <Image className={styles.icon} src="/soccer.svg" alt="Soccer Logo" width={42} height={36} />
            <h2>Soccer</h2>
            <p>
          ...
          <div className={UI.card}>
            <Image className={styles.icon} src="/basketball.svg" alt="Basketball Logo" width={42} height={36} />
            <h2>Basketball</h2>
            <p>
          ...
          <div className={UI.card}> 
            <Image className={styles.icon} src="/movie.svg" alt="Movie Logo" width={42} height={36} />
            <h2>Movies</h2>
            <p>
          ...
          <div className={UI.card}>
            <Image className={styles.icon} src="/games.svg" alt="Games Logo" width={42} height={36} />
            <h2>Video Games</h2>
            <p>
